...
UNIT_TESTS = [
    ...
    'tests/test_journal_pending_recovery.py',
    ...
    'tests/test_session_close_guard.py',
    'tests/test_spread_open_preflight.py',
    ...
    'tests/test_startup_ack_invalidate_ui.py',
    ...
    'tests/test_feishu_alert_cooldown.py',
    'tests/test_unattended_heartbeat.py',
    'tests/test_heartbeat_watchdog.py',
    'tests/test_unattended_observability.py',
    'tests/test_runtime_health_summary.py',
    'tests/test_position_csv_integrity.py',
